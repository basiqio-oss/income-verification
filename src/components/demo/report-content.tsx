...
const isGroupMeaningful = (group: Group) => {
  ...
  return (
    analysis.summary.transactionCount > 0 || // At least one transaction
    Number.parseFloat(analysis.amount.total) > 0 || // Total amount is greater than 0
    Number.parseFloat(analysis.amount.average.transaction) > 0 || // Average transaction is greater than 0
    Number.parseFloat(analysis.amount.average.month) > 0 || // Average per month is greater than 0
    analysis.amount.stableMonths > 0
  ) // At least one stable month
}
...
export default function ReportPage() {
  ...
  const filteredMetrics = reportData.metrics.filter(isMetricMeaningful)

  const filteredGroups = reportData.groups.filter(isGroupMeaningful)

  // Prepare data for charts

  const groupChartData = {
    labels: filteredGroups.map((group) => group.title),
    values: filteredGroups.map((group) => Number.parseFloat(group.analysis.amount.total)),
  }
      ...
      <div className="mb-8">
        ...
        <ul className="space-y-6">
          {filteredMetrics.map((metric) => (
            <li
              key={metric.id}
              className="p-6 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-gray-800"
            >
              ...
              {metric.result && (
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  <strong>Result:</strong> {metric.result.value} {metric.result.format === "money" ? "AUD" : ""}{" "}
                  {/* Display currency if applicable */}
                </p>
              )}
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                      <li>
                        <strong>Start Date:</strong> {group.analysis.range.startDate}
                      </li>
                      <li>
                        <strong>End Date:</strong> {group.analysis.range.endDate}
                      </li>
                      <li>
                        <strong>Duration:</strong> {group.analysis.range.duration} days
                      </li>
                    </ul>
                  </div>
                  {/* Amount Section */}
                  <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                      <li>
                        <strong>Total:</strong> {group.analysis.amount.total}
                      </li>
                      <li>
                        <strong>Min:</strong> {group.analysis.amount.min}
                      </li>
                      <li>
                        <strong>Max:</strong> {group.analysis.amount.max}
                      </li>
                      <li>
                        <strong>Average Transaction:</strong> {group.analysis.amount.average.transaction}
                      </li>
                      <li>
                        <strong>Average Per Month:</strong> {group.analysis.amount.average.month}
                      </li>
                      <li>
                        <strong>Median Transaction:</strong> {group.analysis.amount.average.medianTransaction}
                      </li>
                      <li>
                        <strong>Median Month:</strong> {group.analysis.amount.average.medianMonth}
                      </li>
                      <li>
                        <strong>Ongoing Month:</strong> {group.analysis.amount.average.ongoingMonth}
                      </li>
                      <li>
                        <strong>Stable Months:</strong> {group.analysis.amount.stableMonths}
                      </li>
                      <li>
                        <strong>Secure Months:</strong> {group.analysis.amount.secureMonths}
                      </li>
                    </ul>
                  </div>
                  {/* Frequency Section */}
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                      <li>
                        <strong>Type:</strong> {group.analysis.frequency.type}
                      </li>
                      <li>
                        <strong>Amount:</strong> {group.analysis.frequency.amount}
                      </li>
                      <li>
                        <strong>Display:</strong> {group.analysis.frequency.display}
                      </li>
                      <li>
                        <strong>Next Date:</strong> {group.analysis.frequency.next.date}
                      </li>
                      <li>
                        <strong>Next Amount:</strong> {group.analysis.frequency.next.amount}
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  {group.subgroup.map((subgroup) => (
                    <div
                      key={subgroup.id}
                      className="mb-6 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-gray-800 p-4"
                    >
                      <Accordion
                        title={subgroup.name}
                        content={
                          <div>
                            ...
                            <div className="mt-6">
                              ...
                              <div className="mb-4">
                                ...
                                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                                  <li>
                                    <strong>Transaction Count:</strong> {subgroup.analysis.summary.transactionCount}
                                  </li>
                                  <li>
                                    <strong>Overall Percentage Credit:</strong>{" "}
                                    {subgroup.analysis.summary.overallPercentage.credit}%
                                  </li>
                                  <li>
                                    <strong>Overall Percentage Debit:</strong>{" "}
                                    {subgroup.analysis.summary.overallPercentage.debit}%
                                  </li>
                                </ul>
                              </div>
                              {/* Range Section */}
                              <div className="mb-4">
                                ...
                                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                                  <li>
                                    <strong>Start Date:</strong> {subgroup.analysis.range.startDate}
                                  </li>
                                  <li>
                                    <strong>End Date:</strong> {subgroup.analysis.range.endDate}
                                  </li>
                                  <li>
                                    <strong>Duration:</strong> {subgroup.analysis.range.duration} days
                                  </li>
                                </ul>
                              </div>
                              {/* Amount Section */}
                              <div className="mb-4">
                                ...
                                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                                  <li>
                                    <strong>Total:</strong> {subgroup.analysis.amount.total}
                                  </li>
                                  <li>
                                    <strong>Min:</strong> {subgroup.analysis.amount.min}
                                  </li>
                                  <li>
                                    <strong>Max:</strong> {subgroup.analysis.amount.max}
                                  </li>
                                  <li>
                                    <strong>Average Transaction:</strong> {subgroup.analysis.amount.average.transaction}
                                  </li>
                                  <li>
                                    <strong>Average Per Month:</strong> {subgroup.analysis.amount.average.month}
                                  </li>
                                  <li>
                                    <strong>Median Transaction:</strong>{" "}
                                    {subgroup.analysis.amount.average.medianTransaction}
                                  </li>
                                  <li>
                                    <strong>Median Month:</strong> {subgroup.analysis.amount.average.medianMonth}
                                  </li>
                                  <li>
                                    <strong>Ongoing Month:</strong> {subgroup.analysis.amount.average.ongoingMonth}
                                  </li>
                                  <li>
                                    <strong>Stable Months:</strong> {subgroup.analysis.amount.stableMonths}
                                  </li>
                                  <li>
                                    <strong>Secure Months:</strong> {subgroup.analysis.amount.secureMonths}
                                  </li>
                                </ul>
                              </div>
                              {/* Frequency Section */}
                              <div>
                                ...
                                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                                  <li>
                                    <strong>Type:</strong> {subgroup.analysis.frequency.type}
                                  </li>
                                  <li>
                                    <strong>Amount:</strong> {subgroup.analysis.frequency.amount}
                                  </li>
                                  <li>
                                    <strong>Display:</strong> {subgroup.analysis.frequency.display}
                                  </li>
                                  <li>
                                    <strong>Next Date:</strong> {subgroup.analysis.frequency.next.date}
                                  </li>
                                  <li>
                                    <strong>Next Amount:</strong> {subgroup.analysis.frequency.next.amount}
                                  </li>
                                </ul>
                              </div>
                            </div>
